...
define config.name = _("Novela Visual (IAN)")
...
define gui.about = _p("""Proyecto de Novela Visual con Inteligencia
Artificial (IAN)

{a=https://github.com/ACMUD/Novela_Visual}IAN 2.0{/a}

Este programa es realizado con el objetivo de recopilar técnicas de
inteligencia artificial orientadas a la creación cohesiva de novelas
visuales que cumplan con las características típicas de narrativa e
incluyan nociones de jugabilidad para este tipo de novelas. El objetivo
principal de este proyecto es la variedad de tramas.

Para esta versión:

- Se cuenta con una selección tropica de línea lógica.

- Se cuenta con una ambientación narrativa tropica.

- Se obtiene una línea lógica (logline o sinopsis simplificada).
""")
...
define config.main_menu_music = "audio/music/LaCancionNapo.ogg"
...
define config.save_directory = "Novela-1559936712"
